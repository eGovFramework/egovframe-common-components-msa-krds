...
public class EgovQustnrQesitmAPIController {
    ...
    public ResponseEntity<?> qustnrQesitmInsert(@Valid @ModelAttribute QustnrQesitmVO qustnrQesitmVO, BindingResult bindingResult, HttpServletRequest request) throws FdlException {
