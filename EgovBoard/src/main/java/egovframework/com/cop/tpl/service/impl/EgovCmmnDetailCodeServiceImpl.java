...
import egovframework.com.cop.tpl.repository.EgovCmmnDetailCodeRepository;
...
@Service("tplEgovCmmnDetailCodeServiceImpl")
...
public class EgovCmmnDetailCodeServiceImpl extends EgovAbstractServiceImpl implements EgovCmmnDetailCodeService {
    ...
    public List<CmmnDetailCodeVO> list() {
        return repository.findByCmmnDetailCodeIdCodeId("COM005")
                .stream()
                .map(cmmnDetailCode -> {
